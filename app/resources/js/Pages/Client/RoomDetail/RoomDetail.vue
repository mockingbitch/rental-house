                    ...
                    <div class="form">
                        <div class="form__wrap">
                            ...
                            <div class="note">
                                ...
                                <a v-if="props.room?.images[2]" href="" class="image">
                                    <img
                                        :src="props.room?.images[2]"
                                        alt=""
                                    />
                                </a>
                                <a v-if="props.room?.images[3]" href="" class="image">
                                    <img
                                        :src="props.room?.images[3]"
                                        alt=""
                                    />
                                </a>
                                <span
                                    v-show="
                                        detailForm.moreExperience === false &&
                                        props.house?.description?.length >= 50
                                    "
