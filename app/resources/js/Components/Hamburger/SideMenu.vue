...
<template>
    <div>
        <div v-if="!isSelectLanguage" class="side-menu-container d-flex">
            ...
            <div v-if="!props.userInfo" class="side-menu-content">
                <a
            ...
            <!--            </Link>-->
            <Link :href="route('lessor.register')">
                <div
                    v-if="
                        props.userInfo?.role === 'LESSEE' &&
                        props.userInfo?.verify_lessor !== 'VERIFYING'
                    "
            ...
            >
                ...
                <div>We are verifying your registration...</div>
            </div>
            ...
            <!-- Footer -->
            <div
                v-if="isMobile || props.userInfo?.role !== 'LESSOR'"
        ...
        >
            <div
                v-if="props.userInfo?.role !== 'LESSOR'"
                class="select-language-header-wrap"
            >
                <SubHeader
