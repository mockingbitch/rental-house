<template>
    ...
    >
        ...
        <div class="step-container">
            ...
            <div 
                v-if="form.country_id == 1"
                class="form__wrap-item double-input d-flex flex-row"
            >
                <div class="form-wrap-double">
                    <label for="Title">{{ lang().label.information.account_info.adult_first_name_kana }} <span class="required-input">*</span></label>
                    <input
                        v-model="form.first_name_kana"
                        id="half_width"
                        placeholder="example"
                    />
                    <UlError :message="form.errors.first_name_kana" />
                </div>
                <div class="form-wrap-double">
                    <label for="Title">{{ lang().label.information.account_info.adult_last_name_kana }} <span class="required-input">*</span></label>
                    <input
                        v-model="form.last_name_kana"
                        id="half_width"
                        placeholder="example"
                    />
                    <UlError :message="form.errors.last_name_kana" />
                </div>
            </div>
...
.active {
    ...
    border: 1px solid #418997 !important;
}
.btn_disabled {
