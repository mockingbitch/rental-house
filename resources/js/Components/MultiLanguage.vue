<template>
    <div style="position: relative">
        <div style="cursor: pointer" class="d-flex align-items-center" @click="handleShowLanguageSelect">
            <svg
        ...
        <div
            v-if="isShowLanguageSelect"
            style="position: absolute"
            class="select-language"
        >
            <div @click="handleSelectLanguage('jp')">JP</div>
            <div @click="handleSelectLanguage('en')">EN</div>
            <div @click="handleSelectLanguage('vi')">VIE</div>
        </div>
    </div>
</template>
<script setup>
...
const isShowLanguageSelect = ref(false);
const handleShowLanguageSelect = () => {
    isShowLanguageSelect.value = !isShowLanguageSelect.value;
};
