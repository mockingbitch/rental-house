...
<template>
    <div>
        <div v-if="!isSelectLanguage" class="side-menu-container d-flex">
            ...
            >
                ...
                >
                    <div>
                        ...
                        <span class="side-menu-header-button-text-link">
                            here
                        </span>
                    </div>
                </div>
            </div>
            <div v-if="!page.props.auth?.role" class="side-menu-content">
                <a
            ...
            <div v-if="!page.props.auth?.role" class="side-menu-line"></div>
            <div v-if="!page.props.auth?.role" class="side-menu-content">
                <div
                    class="d-flex align-items-center justify-content-between side-menu-content-item"
                >
                    ...
                    >
                        ...
                        <div
                            class="d-flex align-items-center justify-content-center noneLoginDots fw-700"
                        >
                ...
                >
                    ...
                    >
                        ...
                        <div
                            class="d-flex flex-column justify-content-center noneLoginDots fw-700"
                        >
                            <div>Click here to apply as a lessor!</div>
                            <div class="side-menu-header-button-subtitle">
                                Become a Rentalhouse lessor and have fun!
                            </div>
                        </div>
                    </div>
            ...
            <div
                v-if="
                    page.props.auth?.role == 'Lessor' ||
                    page.props.auth?.role == 'Lessee'
                "
            ...
            >
                <div class="d-flex align-items-center side-menu-header">
                    <img
                        :src="
                            props.userInfo.role == 'Lessor'
                                ? props.userInfo?.lessor_infor?.profile_image ||
            ...
            <Link
                v-if="
                    page.props.auth?.role == 'Lessee' &&
                    props.userInfo?.verify_lessor == 2
                "
                :href="route('top')"
            ...
            <Link :href="route('top')">
                ...
                >
                    ...
                    <div>Become a Rentalhouse lessor!</div>
                </div>
            </Link>
            ...
            >
                <div class="d-flex side-menu-footer-title">
                    <div class="footer-text">Operating company</div>
                    <div>・</div>
                ...
                <div class="side-menu-footer-policy">
                    © 2023 Rentalhouse,Inc. All rights reserved
                </div>
            </div>
        </div>
        <div
        ...
        >
            ...
            <div class="select-language-title">Please select a language</div>
            <div
            ...
            >
                ...
                <img
                    ...
                    src="/img/icon/ApplyToTeacher/Check.svg"
                />
            </div>
        </div>
    </div>
