...
@section('content')
                        ...
                        <tr>
                            <td>
                                <div class="d-flex px-2 py-1">
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm">{{$tag->name_vi}}</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <p class="text-xs text-secondary mb-0">{{$tag->name_en}}</p>
                            </td>
                            <td>
                                <p class="text-xs text-secondary mb-0">{{$tag->description_vi}}</p>
                            </td><td>
                                <p class="text-xs text-secondary mb-0">{{$tag->description_en}}</p>
                            </td><td>
                                <p class="text-xs text-secondary mb-0">{{$tag->icon}}</p>
                            </td><td>
                                <p class="text-xs text-secondary mb-0">{{$tag->status}}</p>
                            </td>
                            ...
                            <td class="align-middle" style="font-size:20px">
                                <a class="text-secondary mx-1 font-weight-bold text-xs" data-toggle="tooltip"
                                    data-original-title="Edit tag" href="{{route('tag.detail', ['id' => $tag->id])}}">
    ...
    @else
    <h2 class="my-4 mx-4">No tag found</h2>
    @endif
