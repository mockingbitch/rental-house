...
!(function () {
    ...
    var e = window.document,
                ...
                var r = "readystatechange",
                    a = function () {
                        if (o.test(e.readyState))
                            return v(e, r, a), t.apply(this, arguments);
                    };
                m(e, r, a);
            }
        },
        ...
        F = function (e, o, t) {
            ...
            if (("." + s).substring(s.length - c.length) !== "." + c)
                return l.removeAttribute("href"), void t(d);
            var h = (" /" + l.pathname).split(/\/+/);
            if (
                ((((s === c || s === "gist." + c) && "archive" === h[3]) ||
                    (s === c &&
                        "releases" === h[3] &&
                        ("download" === h[4] ||
